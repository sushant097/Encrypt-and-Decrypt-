 ...
 */
public class Encryot_Decrypt extends javax.swing.JFrame {
...
//        keyInput = Integer.parseInt(jTextField3.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Encryot_Decrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Encryot_Decrypt().setVisible(true);
            }
        });
    }
